        ...
        <div>
            ...
            <form onSubmit={handleSearch} className="max-w-md mx-auto mt-10">
                <div className="relative">
                    ...
                    <input type="text" className="block w-full p-4 ps-10 text-sm text-rose-400 border border-rose-400 rounded-lg focus:ring-rose-400 focus:border-rose-500" placeholder="Enter Food Name" name="search" required />
            ...
            <div className="flex justify-center my-4">
                ...
                <select id="sortOrder" value={sortOrder} onChange={handleSortOrderChange} className="border border-rose-400 text-rose-400 rounded-lg p-2 focus:ring-rose-400 focus:border-rose-500">
