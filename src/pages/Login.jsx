        ...
        <div className="flex w-full max-w-sm mx-auto my-16 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl ">
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <p className="text-xs text-center text-gray-500 uppercase dark:text-gray-400">or SignIn with email</p>
                ...
                <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                    ...
                    <div className="mb-4 relative">
                        ...
                        <input type={showPassword ? "text" : "password"} placeholder="Password" className="input input-bordered w-full pr-10" name="password" required />
